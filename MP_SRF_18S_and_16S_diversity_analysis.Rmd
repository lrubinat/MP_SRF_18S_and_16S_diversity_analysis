...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 3) + scale_x_continuous(limits = c(0, 130)) + labs(title="[tb1] #samples vs #OTUs", x="samples", y="OTUs") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05, size=3) + scale_x_log10(limits = c(1, 10500)) + scale_y_continuous(trans = "log10") + labs(title="[tb3] #OTUs vs #reads", x="OTUs (log10)", y="reads (log10)") 
```
...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 3) + scale_x_continuous(limits = c(0, 105)) + labs(title="[tb5] #samples vs #OTUs - protists", x="samples (%)", y="OTUs (%)") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05, size=3) + labs(title="[tb6] #OTUs vs #reads - protists", x="OTUs (%)", y="reads (%)") + coord_trans(y = "log10") + scale_x_log10(limits = c(-1, 100))
```
...
tb18S_OTUs_reads_samples_non.norm$samples_per_class<-c(117,117,117,112,117,96,91,103,102,92,44,33,13,36,17,27,5)
...
tb18S_OTUs_reads_samples_rel_abund_non.norm$reads_per_class<-(tb18S_OTUs_reads_samples_rel_abund_non.norm$reads_per_class*100)/colSums(tb18S_OTUs_reads_samples)[1]
tb18S_OTUs_reads_samples_rel_abund_non.norm$OTUs_per_class<-(tb18S_OTUs_reads_samples_rel_abund_non.norm$OTUs_per_class*100)/colSums(tb18S_OTUs_reads_samples)[2]
...
tb16_protists <- tb16_ss5836_tax_sorted[which(tb16_ss5836_tax_sorted$class_A != "heterotrophic_bacteria" & tb16_ss5836_tax_sorted$class_A != "other_cyanobacteria" & tb16_ss5836_tax_sorted$class_A != "Cyanobacteria"),]
...
other_cyanob_tb <- tb16_bacteria[which(tb16_bacteria$class_A == "other_cyanobacteria"),]
other_cyanob_tb_occur <- other_cyanob_tb[,1:117]
...
#table without "heterotropic_bacteria" and "other_cyanobacteria":
tb16S_bacteria_OTUs_reads_samples <- tb16S_bacteria_OTUs_reads_samples[-1,]
```
...
otus_vs_samples_plot_protists + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 3) + scale_x_continuous(limits = c(0, 125)) + labs(title="[1] Number of samples showing occurences of at least 1 OTU ", x="samples", y="OTUs") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot_protists + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05, size=3) + scale_x_continuous(limits = c(0, 30)) + labs(title="[tb6] #OTUs vs #reads - protists", x="OTUs", y="reads") + coord_trans(y = "log10")
```

[[PROTISTS vs CYANOBACTERIA]]
[PLOT DESCRIPTION]
...
otus_vs_samples_plot_protists_plus_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 3) + scale_x_continuous(limits = c(0, 125)) + labs(title="[tb9] #samples vs #OTUs - protists & bacteria", x="samples", y="OTUs")
```
...
otus_vs_samples_plot_protists_plus_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05, size=3) + scale_x_continuous(limits = c(0, 35)) + labs(title="[tb10] #OTUs vs #reads - protists & bacteria", x="OTUs", y="reads") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot_protists + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 3) + scale_x_continuous(limits = c(0, 105)) + labs(title="[tb5] #samples vs #OTUs - protists", x="samples (%)", y="OTUs (%)") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot_protists + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05, size=3) + scale_x_continuous(limits = c(0, 52)) + labs(title="[tb6] #OTUs vs #reads - protists", x="OTUs (%)", y="reads (%)") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot_protists_plus_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 3) + scale_x_continuous(limits = c(0, 105)) + labs(title="[tb9] #samples vs #OTUs - protists & bacteria", x="samples (%)", y="OTUs (%)") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot_protists_plus_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05, size=3) + scale_x_continuous(limits = c(0, 40)) + labs(title="[tb10] #OTUs vs #reads - protists & bacteria", x="OTUs (%)", y="reads (%)") + coord_trans(y = "log10") 
