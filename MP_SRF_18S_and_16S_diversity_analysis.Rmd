...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 5) + scale_x_continuous(limits = c(0, 150)) + labs(title="[tb1] #samples vs #OTUs", x="samples", y="OTUs") + coord_trans(y = "log10")
```
...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 5) + scale_x_continuous(limits = c(0, 150)) + labs(title="[tb2] #samples vs #OTUs", x="samples", y="OTUs")
```
...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05) + scale_x_continuous(limits = c(0, 8000)) + labs(title="[tb3] #OTUs vs #reads", x="OTUs", y="reads")
```
...
otus_vs_samples_plot + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05) + scale_x_continuous(limits = c(0, 350)) + labs(title="[tb4] #OTUs vs #reads", x="OTUs", y="reads")
```
...
tb16_bacteria <- tb16_ss5844_tax_sorted[which(tb16_ss5844_tax_sorted$taxonomic_classes != "Bolidophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "Chlorarachniophyta" & tb16_ss5844_tax_sorted$taxonomic_classes != "Cryptophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "Pelagophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "Rappemonad" & tb16_ss5844_tax_sorted$taxonomic_classes != "Cryptomonadales" & tb16_ss5844_tax_sorted$taxonomic_classes != "Bacillariophyta" & tb16_ss5844_tax_sorted$taxonomic_classes != "Dictyochophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "Mamiellophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "Prasinophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "Eustigmatales" & tb16_ss5844_tax_sorted$taxonomic_classes != "Trebouxiophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "Prymnesiophyceae" & tb16_ss5844_tax_sorted$taxonomic_classes != "other_plastids"),]

tb16_protists <- tb16_ss5844_tax_sorted[which(tb16_ss5844_tax_sorted$taxonomic_classes != "heterotrophic_bacteria" & tb16_ss5844_tax_sorted$taxonomic_classes != "other_cyanobacteria" & tb16_ss5844_tax_sorted$taxonomic_classes != "Prochlorococcus" & tb16_ss5844_tax_sorted$taxonomic_classes != "Synechococcus"),]
...
class_summary_reads_per_class_16S_protists<-aggregate(rowSums(tb16_protists[1:119]), list(tb16_protists$taxonomic_classes), sum)
# count the different groups

class_summary_otus_per_class_16S_protists<-aggregate(rowSums(tb16_protists[1:119]), list(tb16_protists$taxonomic_classes), length)
...
class_summary_reads_per_class_16S_bacteria<-aggregate(rowSums(tb16_bacteria[1:119]), list(tb16_bacteria$taxonomic_classes), sum)
# count the different groups

class_summary_otus_per_class_16S_bacteria<-aggregate(rowSums(tb16_bacteria[1:119]), list(tb16_bacteria$taxonomic_classes), length)
...
#create a table per group and count in how many samples they occur. 
other_plastids_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "other_plastids"),]
other_plastids_tb[1:5,1:5]
other_plastids_tb_occur <- other_plastids_tb[,1:119]
...
Prymnesiophyceae_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Prymnesiophyceae"),]
Prymnesiophyceae_tb_occur <- Prymnesiophyceae_tb[,1:119]
length(Prymnesiophyceae_tb_occur[,colSums(Prymnesiophyceae_tb_occur) > 0])

Prasinophyceae_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Prasinophyceae"),]
Prasinophyceae_tb_occur <- Prasinophyceae_tb[,1:119]
length(Prasinophyceae_tb_occur[,colSums(Prasinophyceae_tb_occur) > 0])

Dictyochophyceae_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Dictyochophyceae"),]
Dictyochophyceae_tb_occur <- Dictyochophyceae_tb[,1:119]
length(Dictyochophyceae_tb_occur[,colSums(Dictyochophyceae_tb_occur) > 0])

Mamiellophyceae_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Mamiellophyceae"),]
Mamiellophyceae_tb_occur <- Mamiellophyceae_tb[,1:119]
length(Mamiellophyceae_tb_occur[,colSums(Mamiellophyceae_tb_occur) > 0])

Bacillariophyta_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Bacillariophyta"),]
Bacillariophyta_tb_occur <- Bacillariophyta_tb[,1:119]
length(Bacillariophyta_tb_occur[,colSums(Bacillariophyta_tb_occur) > 0])

Bolidophyceae_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Bolidophyceae"),]
Bolidophyceae_tb_occur <- Bolidophyceae_tb[,1:119]
length(Bolidophyceae_tb_occur[,colSums(Bolidophyceae_tb_occur) > 0])

Chlorarachniophyta_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Chlorarachniophyta"),]
Chlorarachniophyta_tb_occur <- Chlorarachniophyta_tb[,1:119]
length(Chlorarachniophyta_tb_occur[,colSums(Chlorarachniophyta_tb_occur) > 0])

Cryptomonadales_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Cryptomonadales"),]
Cryptomonadales_tb_occur <- Cryptomonadales_tb[,1:119]
length(Cryptomonadales_tb_occur[,colSums(Cryptomonadales_tb_occur) > 0])

Pelagophyceae_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Pelagophyceae"),]
Pelagophyceae_tb_occur <- Pelagophyceae_tb[,1:119]
length(Pelagophyceae_tb_occur[,colSums(Pelagophyceae_tb_occur) > 0])

Rappemonad_tb <- tb16_protists[which(tb16_protists$taxonomic_classes == "Rappemonad"),]
Rappemonad_tb_occur <- Rappemonad_tb[,1:119]
length(Rappemonad_tb_occur[,colSums(Rappemonad_tb_occur) > 0])
```

```{r count_samples_per_group_16S_bacteria, echo=FALSE}
#create a table per group and count in how many samples they occur. 
heterotrophic_bacteria_tb <- tb16_bacteria[which(tb16_bacteria$taxonomic_classes == "heterotrophic_bacteria"),]
heterotrophic_bacteria_tb_occur <- heterotrophic_bacteria_tb[,1:119]
length(heterotrophic_bacteria_tb_occur[,colSums(heterotrophic_bacteria_tb_occur) > 0])

other_cyanob_tb <- tb16_bacteria[which(tb16_bacteria$taxonomic_classes == "other_cyanobacteria"),]
other_cyanob_tb_occur <- other_cyanob_tb[,1:119]
length(other_cyanob_tb_occur[,colSums(other_cyanob_tb_occur) > 0])

Prochlorococcus_tb <- tb16_bacteria[which(tb16_bacteria$taxonomic_classes == "Prochlorococcus"),]
Prochlorococcus_tb_occur <- Prochlorococcus_tb[,1:119]
length(Prochlorococcus_tb_occur[,colSums(Prochlorococcus_tb_occur) > 0])

Synechococcus_tb <- tb16_bacteria[which(tb16_bacteria$taxonomic_classes == "Synechococcus"),]
Synechococcus_tb_occur <- Synechococcus_tb[,1:119]
length(Synechococcus_tb_occur[,colSums(Synechococcus_tb_occur) > 0])
```
...
tb16S_protists_OTUs_reads_samples$samples_per_class<-c(118,117,114,98,31,26,21,27,13,13,2)

#table without "other_plastids"
#tb16S_protists_OTUs_reads_samples_without_op <- tb16S_protists_OTUs_reads_samples[-1,]
```
...
tb16S_bacteria_OTUs_reads_samples$samples_per_class<-c(119,119,119,107)

#table without "heterotropic_bacteria"
tb16S_bacteria_OTUs_reads_samples_without_hb <- tb16S_bacteria_OTUs_reads_samples[-1,]
```
...
otus_vs_samples_plot_protists + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 5) + scale_x_continuous(limits = c(0, 150)) + labs(title="[tb5] #samples vs #OTUs - protists", x="samples", y="OTUs")
```
...
otus_vs_samples_plot_protists + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05) + scale_x_continuous(limits = c(0, 32)) + labs(title="[tb6] #OTUs vs #reads - protists", x="OTUs", y="reads")
```

[[BACTERIA]]
[PLOT DESCRIPTION]

```{r stations_vs_OTUs_bacteria, echo=FALSE}
otus_vs_samples_plot_bacteria <- ggplot(tb16S_bacteria_OTUs_reads_samples, aes(samples_per_class,OTUs_per_class, label = rownames(tb16S_bacteria_OTUs_reads_samples)))
otus_vs_samples_plot_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 5) + scale_x_continuous(limits = c(0, 150)) + labs(title="[tb7] #samples vs #OTUs - bacteria", x="samples", y="OTUs")
```

[PLOT DESCRIPTION]

```{r OTUs_vs_reads_bacteria, echo=FALSE}
otus_vs_samples_plot_bacteria <- ggplot(tb16S_bacteria_OTUs_reads_samples, aes(OTUs_per_class, reads_per_class, label = rownames(tb16S_bacteria_OTUs_reads_samples)))
otus_vs_samples_plot_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05) + scale_x_continuous(limits = c(0, 1000)) + labs(title="[tb8] #OTUs vs #reads - protists", x="OTUs", y="reads")
```

[PLOT DESCRIPTION]

```{r OTUs_vs_reads_bacteria_without_hb, echo=FALSE}
otus_vs_samples_plot_bacteria_without_hb <- ggplot(tb16S_bacteria_OTUs_reads_samples_without_hb, aes(OTUs_per_class, reads_per_class, label = rownames(tb16S_bacteria_OTUs_reads_samples_without_hb)))
otus_vs_samples_plot_bacteria_without_hb + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05) + scale_x_continuous(limits = c(0, 17)) + labs(title="[tb8] #OTUs vs #reads - protists", x="OTUs", y="reads")
```
...
tb16S_protists_plus_bacteria_OTUs_reads_samples<-rbind(tb16S_protists_OTUs_reads_samples,tb16S_bacteria_OTUs_reads_samples_without_hb)
```
...
otus_vs_samples_plot_protists_plus_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_y = 0.05, size = 5) + scale_x_continuous(limits = c(0, 150)) + labs(title="[tb9] #samples vs #OTUs - protists & bacteria", x="samples", y="OTUs")
```
...
otus_vs_samples_plot_protists_plus_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05) + scale_x_continuous(limits = c(0, 35)) + labs(title="[tb10] #OTUs vs #reads - protists & bacteria", x="OTUs", y="reads")
```
