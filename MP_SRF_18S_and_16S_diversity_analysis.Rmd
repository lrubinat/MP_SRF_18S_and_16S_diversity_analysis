...
cyano_OTUs_reads_rel_abund2<-read.table("/home/laura/Documents/TFM/home/data/MALASPINA/Malaspina_16S_Surface/table_with_BLAST/cyano_histograms_data4.txt", head=TRUE)
...
ggplot(tb16S_protists_plus_bacteria_OTUs_reads_samples) +
  geom_point(aes(OTUs_per_class,reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class,reads_per_class, label = rownames(tb16S_protists_plus_bacteria_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_log10(limits = c(-1,100), breaks=c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,1000000), breaks = c(0,0.1,1,10,100,1000,10000,100000,1000000)) + labs(title="[10.2] Reads per class vs. OTUs per class", x="\nMP-iTags-16S OTUs", y="MP-iTags-16S reads\n") + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
