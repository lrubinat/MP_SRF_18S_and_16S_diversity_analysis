...
otus_vs_samples_plot_protists_plus_bacteria + geom_point() + geom_text(check_overlap = TRUE,hjust = -0.05, nudge_x = 0.05) + scale_x_continuous(limits = c(0, 32)) + labs(title="[tb10] #OTUs vs #reads - protists & bacteria", x="OTUs", y="reads")
```
